...
\item Create two variables and store a random integer between 0 and 100 in each one.
Use the \verb|Math.random()| function to generate these values.

\item Use the difference function on the two random integers to tell which of the two are bigger,
...
\item \textbf{Challenge:} Create an array of 10 random integers between 0 and 100,
and use the difference function to find the largest and smallest values in the array.

Another way to think of this problem is to find the largest difference between two numbers in the array.
